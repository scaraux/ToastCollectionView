...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/gottingoscar@gmail.com/ToastCollectionViewCell'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gottingoscar@gmail.com' => 'gottingoscar@gmail.com' }
  s.source           = { :git => 'https://github.com/gottingoscar@gmail.com/ToastCollectionViewCell.git', :tag => s.version.to_s }
